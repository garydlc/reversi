...
console.log('Gary about to connect');
/* Connect to the socket server*/
var socket = io.connect();

console.log('Gary about to connect finished');
...
socket.on('send_message_response', function(payload){
    console.log('vr received message 3');
    ...
    if (payload.result == 'fail'){
        ...
        document.getElementById("233").dispatchEvent(evt_down);document.getElementById("233").dispatchEvent(evt_up);
    }
...
socket.on('game_update', function(payload){
    ...
    $('#my_whose_turn').html('<h4 class="robotoFont" >It\'s is '+payload.game.whose_turn+'\'s turn.</h4>');
    $('#my_time_left').html('<h4 class="robotoFont" >Elapsed time <span id="elapsed"></span></h4>');
